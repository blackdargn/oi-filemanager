...
public class FileHolderListAdapter extends BaseAdapter {
	...
	private int mItemLayoutId = R.layout.item_filelist_multiselect;
	
	// Thumbnail specific
    private ThumbnailLoader mThumbnailLoader;
    private boolean scrolling = false;
	
    public boolean isMutilSelable = false;
	...
	public boolean changeMutilMode() {
	    isMutilSelable = !isMutilSelable;
	    notifyDataSetChanged();
	    return isMutilSelable;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
			convertView = newView();		
		CheckableFileListItem holder = (CheckableFileListItem) convertView;
		...
		holder.mCheckbox.setVisibility(isMutilSelable ? View.VISIBLE : View.GONE);
